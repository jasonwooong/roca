...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Map'
        db.create_table(u'blog_map', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
        ))
        db.send_create_signal(u'blog', ['Map'])

        # Adding M2M table for field related_posts on 'Map'
        db.create_table(u'blog_map_related_posts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('map', models.ForeignKey(orm[u'blog.map'], null=False)),
            ('blogpost', models.ForeignKey(orm[u'blog.blogpost'], null=False))
        ))
        db.create_unique(u'blog_map_related_posts', ['map_id', 'blogpost_id'])


    def backwards(self, orm):
        # Deleting model 'Map'
        db.delete_table(u'blog_map')

        # Removing M2M table for field related_posts on 'Map'
        db.delete_table('blog_map_related_posts')
