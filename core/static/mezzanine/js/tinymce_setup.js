...
if (typeof tinyMCE != 'undefined') {
    ...
    tinyMCE.init({
        ...
        theme_advanced_buttons1: "bold,italic,|,link,unlink,|,image,|,media,charmap,|,code,|,table,|,bullist,numlist,blockquote,indent,outdent,|,undo,redo,|,formatselect,|,search,replace,|,fullscreen,",
