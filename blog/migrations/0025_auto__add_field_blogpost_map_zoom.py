...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.map_zoom'
        db.add_column(u'blog_blogpost', 'map_zoom',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.map_zoom'
        db.delete_column(u'blog_blogpost', 'map_zoom')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'map_zoom': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
