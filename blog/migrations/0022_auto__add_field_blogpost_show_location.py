...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.show_location'
        db.add_column(u'blog_blogpost', 'show_location',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.show_location'
        db.delete_column(u'blog_blogpost', 'show_location')
