...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_categories on 'Map'
        db.create_table(u'blog_map_related_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('map', models.ForeignKey(orm[u'blog.map'], null=False)),
            ('blogcategory', models.ForeignKey(orm[u'blog.blogcategory'], null=False))
        ))
        db.create_unique(u'blog_map_related_categories', ['map_id', 'blogcategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_categories on 'Map'
        db.delete_table('blog_map_related_categories')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'show_location': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'show_map': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
        ...
        u'blog.map': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Map', '_ormbases': [u'pages.Page']},
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'related_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['blog.BlogCategory']", 'symmetrical': 'False', 'blank': 'True'}),
            'related_posts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['blog.BlogPost']", 'symmetrical': 'False', 'blank': 'True'})
        },
        u'comments.comment': {
